...
import 'model/messCalEvent.dart';
import 'model/notification.dart';
import 'model/offeredAchievements.dart';
import 'model/offersecret.dart';
import 'model/post.dart';
import 'model/user.dart';
import 'model/venter.dart';
import 'model/venue.dart';
import 'request/ach_verify_request.dart';
import 'request/achievement_create_request.dart';
import 'request/achievement_hidden_patch_request.dart';
import 'request/action_community_post_request.dart';
import 'request/chatbotlog_request.dart';
import 'request/comment_create_request.dart';
import 'request/complaint_create_request.dart';
import 'request/event_create_request.dart';
import 'request/postFAQ_request.dart';
import 'request/update_community_post_request.dart';
import 'request/user_fcm_patch_request.dart';
import 'request/user_scn_patch_request.dart';
import 'response/achievement_create_response.dart';
import 'response/alumni_login_response.dart';
import 'response/community_post_list_response.dart';
import 'response/event_create_response.dart';
import 'response/explore_response.dart';
import 'response/getencr_response.dart';
import 'response/image_upload_response.dart';
import 'response/news_feed_response.dart';
import 'response/secret_response.dart';
import 'response/user_tags_reach_response.dart';
...
abstract class InstiAppApi {
  ...
  Future<OfferedAchievements> createAchievement(
